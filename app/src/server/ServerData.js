import * as jsonData from '../tools/ExternalConst';
import * as constants from '../tools/Constants';
import ArrowInfo from '../data/ArrowInfo';
import ExhibitsInfo from '../data/ExhibitsInfo';
import FacadeByPanoIDInfo from '../data/FacadeByPanoIDInfo';
import FloorsInfo from '../data/FloorsInfo';
import MarkerInfo from '../data/MarkerInfo';
import MultiDataByParentIDInfo from '../data/MultiDataByParentIDInfo';
import ThumbnailsInfo from '../data/ThumbnailsInfo';
...
class ServerData {
     ...
     */
    getConfig() {
        console.info(jsonData.server_json);
        this.museumID = jsonData.server_json.museumID;
        this.displayID = jsonData.server_json.displayID;
        this.serverURL = jsonData.server_json.serverUrl;
        this.musServerURL = jsonData.server_json.musServerUrl;
        this.firstPanoID = jsonData.server_json.firstPanoID;
        this.resourcesUrl = jsonData.server_json.resourcesUrl;
        this.featuresObj = jsonData.server_json.data;
